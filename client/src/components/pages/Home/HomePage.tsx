...
const HomePage = () => {
  return <div className='flex flex-col md:flex-row items-start gap-6 overflow-hidden'>
    <div id="main" className='space-y-6 w-full md:w-[70%] min-w-0'>
      <Banner />
      <CareerStates />
      <Featured />
    </div>

    <div id="right-side" className='space-y-6 w-full md:w-[30%] min-w-0 overflow-hidden'>
      <SkillsSet />
      <Expertise />
      <GetInTouch />
    </div>
